# Project AGENTS.md (web template)
...
- `./agent/docs/arch.md` - concise architecture summary (purpose/stack/boundaries/deployment).
- `./agent/docs/kb.md` - decisions, assumptions, and references.
- `./agent/docs/run.md` - operational run/build/deploy instructions.
- `./agent/specs/000-roadmap.md` - project-level roadmap with global goals and statuses.
- `./agent/scripts/run.sh` - runtime entrypoint.
- `./agent/scripts/build.sh` - build entrypoint.
- `./agent/scripts/monitor.sh` - monitoring/status entrypoint.
- `./agent/src/.gitkeep` - source tree anchor for bootstrap consistency.

## Web Constraints
- Project should remain deployable.
- Containerization is recommended by default.
...
- `agent/docs/arch.md` must be initially populated with project purpose, stack, boundaries, and deployment model.
